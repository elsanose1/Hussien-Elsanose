...
const modalsBtns = Array.from(
  document.querySelectorAll(".modal-button-opener")
);
modalsBtns.forEach((modal) => {
  modal.addEventListener("click", (e) => {
    const modalId = e.target.getAttribute("data-panel-id");
    const modal = document.querySelector(`#${modalId}`);
    const modalOverlay = modal.querySelector(".modal-overlay");
    modalOverlay.addEventListener("click", (e) => {
      modal.classList.add("hidden");
    });
    const modalClose = modal.querySelector(".panel-close-button");
